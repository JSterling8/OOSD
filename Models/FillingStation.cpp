...
// Description :
 *
 * Don't forget to add C:\MinGW\lib to library path
 * And ws2_32 to libraries
 * You need to do this to link in the libws2_32.a library on a gcc build
 * MSVS requires ws2_32.dll or ws2_32.lib - Watch out for this sort of stuff
//============================================================================
 */
...
#include "../Models/FillingStation.h"
#include <iostream>

//#include "stdafx.h"  //A Windows thing
#include "winsock2.h"
#include "conio.h"
...
int main(int argc, char * argv[]) {
	...
	cout << "Requires a running server to make a connection?" << endl; //
	cout << "Enter a few characters maximum 9" << endl;
